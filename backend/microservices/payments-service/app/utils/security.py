...
PAYMENT_MANAGER_ROLES = {"SUPER_ADMIN", "ADMIN"}
...
def get_current_user(request: Request) -> AuthenticatedUser:
    ...
    if normalized_role is None:
        raise HTTPException(
            status_code=status.HTTP_503_SERVICE_UNAVAILABLE if introspected else status.HTTP_401_UNAUTHORIZED,
            detail="Rol de sesion invalido.",
        )
