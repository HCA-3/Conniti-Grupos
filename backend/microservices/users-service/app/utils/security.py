...
def get_current_user(request: Request) -> AuthenticatedUser:
    ...
    if settings.AUTH_INTROSPECTION_ENABLED:
        ...
        ROLE_ALIASES = {
            "super_admin": "SUPER_ADMIN", "superuser": "SUPER_ADMIN",
            "admin": "ADMIN", "staff": "ADMIN", "content_manager": "ADMIN",
            "participant": "PARTICIPANT", "viewer": "PARTICIPANT",
            "docente": "PARTICIPANT", "estudiante": "PARTICIPANT",
            "externo": "PARTICIPANT", "external": "PARTICIPANT",
            "university_community": "PARTICIPANT", "user": "PARTICIPANT",
        }
        normalized_role = ROLE_ALIASES.get(role.strip().lower()) if isinstance(role, str) else None
...
ADMIN_ROLES = SUPERADMIN_ROLES | {"ADMIN", "staff", "admin", "content_manager"}
...
def require_admin(
    ...
    """Permite administrar la plataforma a SUPER_ADMIN y ADMIN."""
...
# Alias transitorio para importaciones antiguas dentro del servicio.
