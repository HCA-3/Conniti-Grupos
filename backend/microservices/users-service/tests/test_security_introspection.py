...
def test_introspection_normalizes_valid_contract(monkeypatch):
    ...
    assert current.role == "SUPER_ADMIN"
...
@pytest.mark.parametrize(
    ...
    [
        [],
        {"active": True, "user_id": "not-a-uuid", "role": "PARTICIPANT", "session_version": 1},
        {"active": True, "user_id": str(uuid.uuid4()), "role": "owner", "session_version": 1},
        {"active": True, "user_id": str(uuid.uuid4()), "role": "PARTICIPANT", "session_version": True},
    ],
)
