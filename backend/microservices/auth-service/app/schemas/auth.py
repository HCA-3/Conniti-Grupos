...
class RegisterRequest(BaseModel):
    ...
    def validate_role(cls, value: str) -> str:
        ...
        participant_aliases = {
            "participant", "viewer", "docente", "profesor", "estudiante",
            "student", "university_community", "externo", "invitado",
            "external", "user",
        }
        if cleaned.lower() not in participant_aliases:
            raise ValueError("El auto-registro solo permite el rol PARTICIPANT.")
        return "PARTICIPANT"
