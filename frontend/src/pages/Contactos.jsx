                ...
                <section className={styles.contactLayout}>
                    ...
                    <aside className={styles.mapPanel} aria-label="Referencia de ubicación">
                        <div className={styles.mapVisual}>
                            ...
                            <div style={{ marginTop: '1rem', fontSize: '0.9rem', textAlign: 'left', background: 'rgba(255,255,255,0.1)', padding: '10px', borderRadius: '8px' }}>
                                <strong>Sedes y Auditorios:</strong>
                                <ul style={{ listStyle: 'none', padding: 0, margin: '10px 0 0 0' }}>
                                    <li>📍 Auditorio Paraninfo (Cap. 100)</li>
                                    <li>📍 Auditorio Torres (Cap. 100)</li>
                                    <li>📍 Auditorio Sede 4 - Salas 1 a 6 (Cap. 30 c/u)</li>
                                </ul>
                            </div>
                        </div>
