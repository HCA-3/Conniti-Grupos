...
import SitePersonalizationPanel from '../components/admin/SitePersonalizationPanel';
...
export default function SuperuserDashboard() {
    ...
    const availableTabs = ['admin', 'customization', 'users', 'groups', 'committee', 'raffles'];
    if (canManageAdmins) availableTabs.push('staff');
    ...
    return (
        <div>
            ...
            {activeTab === 'staff' && canManageAdmins && <StaffPanel />}
        </div>
    );
}
